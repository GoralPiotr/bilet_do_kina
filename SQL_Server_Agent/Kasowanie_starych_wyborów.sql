...
/****** Object:  Job [Kasowanie_starych_wyborów]    Script Date: 04.07.2022 11:50:22 ******/
BEGIN TRANSACTION
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Kasowanie_starych_wyborów', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Kasowanie_wyborów]    Script Date: 04.07.2022 11:50:23 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Kasowanie_wyborów', 
		@step_id=1, 
